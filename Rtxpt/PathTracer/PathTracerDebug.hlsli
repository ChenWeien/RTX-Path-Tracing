...
enum class DebugViewType : int
{
    ...
    FirstHitSssColor,
    FirstHitNeeValid,
    FirstHitNeeLightSampleBsdfThp,
    FirstHitFalcorDiffusePdf,
    FirstHitFalcorDiffuseTrans,
    FirstHitFalcorSpecularTrans,
    FirstHitIsSss,
    FirstHitDiffuseReflectionEval,
    FirstHitSssView,
    FirstHitSssAlbedo,
    FirstHitNearbyDistance,
    FirstHitX1Position,
    FirstHitX2Position,
    FirstHitSssDistanceLength,
    FirstHitValidSssSample,
    FirstHitScatterDistance,
    FirstHitSssDiffusionProfile,
    ImagePlaneRayLength,
